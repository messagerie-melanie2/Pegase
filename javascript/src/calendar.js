        ...
        function() {
              ...
              .fullCalendar(
                  {
                    ...
                    eventMouseover : function(calEvent, domEvent) {
                      if (calEvent.id.indexOf('edit_date') == -1)
                        return;
                    ...
                    dayNames : [ poll.labels.Sunday, poll.labels.Monday,
                        ...
                        poll.labels.Thursday, poll.labels.Friday,
                        poll.labels.Saturday ],
          ...
          if (poll.env.can_get_freebusy) {
            $('#calendar td.fc-header-right')
                .append(
                    '<span style="-moz-user-select: none;" unselectable="on" class="fc-button hide-calendar fc-button-hide-calendar fc-state-default fc-corner-right">'
            ...
            $('#calendar td.fc-header-right span.fc-button-next').removeClass(
                'fc-corner-right');
