...
<div class="toolbar" role="toolbar">	
	...
	<?php if (o::get_env("page") == 'edit' || o::get_env("page") == 'edit_date' || o::get_env("page") == 'edit_prop' || o::get_env("page") == 'edit_rdv' || o::get_env("page") == 'edit_end') { ?>
		...
		<?php } else { ?>
	        ...
	        <a id="button_refresh_poll" title="<?= l::g("Clic to refresh the poll", false) ?>" class="button notext" href="<?= o::url(null, null, array('u' => p::get_current_poll()->poll_uid)) ?>"><?= l::g('Refresh poll') ?></a>
			...
			<a id="button_export_csv" title="<?= l::g("Clic to export in CSV", false) ?>" class="button notext" href="<?= o::url(null, ACT_DOWNLOAD_CSV, array("u" => p::get_current_poll()->poll_uid, "t" => s::getCSRFToken())) ?>"><?= l::g('Export CSV') ?></a>
			
	        <a id="help-page-button" title="<?= l::g("View help of the page", false) ?>" class="button notext" href="#"><?= l::g('Help') ?></a>
