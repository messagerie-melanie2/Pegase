...
<div id="prevcontent">
    ...
    <div id="content">
        ...
        <div id="edit">
    		<form id="calendar_form" action="<?= o::url("edit_end", o::get_env("action"), array('u' => p::get_current_poll()->poll_uid)) ?>" method="post" onsubmit="setFormSubmitting()" class="pure-form pure-form-aligned">
    			<fieldset>
    			    <div class="pure-controls" style="margin-left: 40%;">
