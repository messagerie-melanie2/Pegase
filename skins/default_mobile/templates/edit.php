...
<div id="prevcontent">
    <div id="content">
        ...
        <?php if (p::isset_current_poll()
            ...
            <div><a class="pure-button pure-button-see-poll" href="<?= o::url("show", null, array("u" => p::get_current_poll()->poll_uid)) ?>"><img alt="See" src="skins/<?= o::get_env("skin") ?>/images/1395933052_message-01_white.png" height="15px"/> <?= l::g('See the poll') ?></a></div>
            <div><a class="pure-button pure-button-edit-poll" href="<?= o::url("edit_".p::get_current_poll()->type, ACT_MODIFY, array("u" => p::get_current_poll()->poll_uid)) ?>"><img alt="List" src="skins/<?= o::get_env("skin") ?>/images/1395932290_list-01_white.png" height="15px"/> <?= l::g('Modify propositions') ?></a></div>
