...
<div id="prevcontent">
    <div id="content">
        ...
        <div id="newpoll">
            <a class="pure-button pure-button-light-red" style="width: 95%;" title="<?= l::g("Create a new poll", false) ?>" href="<?= o::url("edit", ACT_NEW) ?>"><img alt="Add" src="skins/<?= o::get_env("skin") ?>/images/1395836978_add_new_poll.png" height="15px"/> <?= l::g('Create new poll') ?></a>
        </div>
