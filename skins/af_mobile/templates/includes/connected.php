...
<div id="conn">
    ...
    <?php if (o::get_env("page") != "main") { ?>
        ...
        <div><a class="pure-button pure-button-new-poll" title="<?= l::g("Create a new poll", false) ?>" href="<?= o::url("edit", ACT_NEW) ?>"><img alt="Add" src="skins/<?= o::get_env("skin") ?>/images/1395836978_add_new_poll.png" height="40px"/> <?= l::g('New poll') ?></a></div>
    <?php } ?>    
