...
<div id="prevcontent">
    <div id="content">
        ...
        <div><a class="pure-button pure-button-edit-poll" href="<?= o::url("edit", ACT_MODIFY, array('u' => p::get_current_poll()->poll_uid)) ?>"><img alt="Modify" src="skins/<?= o::get_env("skin") ?>/images/1395932254_gear-01_white.png" height="40px"/> <?= l::g('Return to the edit page of poll') ?></a></div>
        <?php if (p::isset_current_poll()
                    && o::get_env("action") != ACT_NEW) { ?>
                <div><a class="pure-button pure-button-see-poll" href="<?= o::url(null, null, array("u" => p::get_current_poll()->poll_uid)) ?>"><img alt="See" src="skins/<?= o::get_env("skin") ?>/images/1395933052_message-01_white.png" height="40px"/> <?= l::g('See the poll') ?></a></div>
        <?php }?>
        <br>
