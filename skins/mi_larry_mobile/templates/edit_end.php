...
<div data-role="page">
    <div data-role="header" data-position="fixed">
        ...
        <?php if (u::isset_current_user()) { ?>
            ...
            <a class="pure-button-disconnect ui-btn ui-btn-icon-right ui-icon-power ui-btn-icon-notext" data-role="button" title="<?= l::g("Disconnect from the app", false) ?>" href="<?= o::url("logoutPortail") ?>"><?= l::g('Disconnect') ?></a>
          </div>
        <?php } ?>
  	</div>
