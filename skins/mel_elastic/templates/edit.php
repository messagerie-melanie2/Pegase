				...
				<form id="edit_form" action="<?= o::url(p::isset_current_poll() ? "edit_" . p::get_current_poll()->type : "edit_date", o::get_env("action"), array("u" => o::get_env("poll_uid"))) ?>" method="post" class="pure-form">
					<fieldset id="edit_fieldset">
								...
								<div class= "reasons-manager" hidden=true>
									...
									<form class="js-form pure-control-group">
										<div class="add-reason-bar">
											<input type="text" aria-label="Enter a new reason" placeholder="<?= l::g('motif name') ?>" class="js-reason-input">
											<input type="button" value="add" class="js-reason-add material-symbols-outlined">
										</div>
									</form>
								</div>
							</div>
						...
						<div class="pure-control-group advanced_option children">
							<label for="edit_only_auth_user" class="customtooltip_right container" title="<?= l::g("This poll is only open for auth users", false) ?>">
						...
						<div class="pure-control-group advanced_option children">
							<label for="edit_prop_in_agenda" class="customtooltip_right container" title="<?= l::g("Check to display proposals in my Agenda", false) ?>">
						...
						<div class="pure-control-group advanced_option children">
							<label for="edit_if_needed" class="customtooltip_right container" title="<?= l::g("This poll allows users to use the if needed answer", false) ?>">
						...
						<div class="pure-control-group advanced_option children">
							<label for="edit_anonymous" class="customtooltip_right container" title="<?= l::g("Check this for an anonyme poll, user cannot see others responses until the poll is lock", false) ?>">
