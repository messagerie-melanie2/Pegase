...
<?php t::inc('head') ?>
            ...
            <br>
            <div id="calendar" title="<?= l::g('Select dates by clicking in the calendar') ?>" class="customtooltip_top"></div>
            ...
            <div id="edit">
                <form action="<?= o::url("edit_end", o::get_env("action"), array('u' => p::get_current_poll()->poll_uid)) ?>" method="post" onsubmit="setFormSubmitting()" class="pure-form pure-form-aligned">
                    <fieldset>
                        <div id="props_list" style="margin-left: 5%;">
                            <h2><?= l::g("Periods") ?></h2>
                            <?= e::ShowProps() ?>
                        </div>
                        <div id="props_new" style="margin-left: 5%;"></div>
