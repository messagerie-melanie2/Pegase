                ...
                <form action="<?= o::url("register") ?>" method="post" class="pure-form pure-form-aligned" autocomplete="on">
                    <fieldset>
                        ...
                        <div class="pure-control-group">
                            <label style="width: 250px;" for="fullname"><?= l::g('Fullname') ?><span style="color: red;">*</span></label>
                            <input style="width: 250px;" id="fullname" type="text" name="fullname"
                        ...
                        <div class="pure-control-group">
                            <label style="width: 250px;" for="email"><?= l::g('Email') ?><span style="color: red;">*</span></label>
                            <input style="width: 250px;" id="email" type="text" name="email"
