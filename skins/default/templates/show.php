      ...
      <?php } else { ?>
        ...
        <?php if (p::isset_current_poll()) { ?>
          <div id="head" class="<?= o::tohtml(p::get_current_poll()->type) ?>">
            ...
            <?php if (!u::isset_current_user() && p::get_current_poll()->auth_only) { ?>
              <span class="no-authenticate-message">Ce sondage est reservé aux utilisateurs authentifiés</span>
            <?php } ?>
                  ...
                  <div class="check">
                    ...
                    <div class="options">
                      <ul>
                        ...
                        <?php if (p::get_current_poll()->type == 'date' && u::isset_current_user()) { ?>
