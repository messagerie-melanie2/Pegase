...
abstract class Driver {
  ...
  /**
   * Est-ce que le driver permet l'autocompletion
   * @var boolean
   */
  public $CAN_AUTOCOMPLETE = false;
   ...
   */
  function get_user_freebusy($start = null, $end = null, $user = null) {
  	...
  	if (\Config\IHM::$SHOW_OTHERS_POLLS_FREEBUSY
  	    && $user->user_id == \Program\Data\User::get_current_user()->user_id) {
   ...
   */
  abstract function add_to_calendar($date, $poll = null, $user = null, $status = null, $part_status = null);
   ...
   */
  function generate_ics($date, $poll = null, $user = null, $status = null, $part_status = null, $request = false) {
   ...
   */
  abstract function event_exists($date, $event_uid = null, $poll = null, $user = null, $status = null);
   ...
   */
  abstract function delete_event($date, $event_uid = null, $poll = null, $user = null);
}