 ...
 */
class Edit_prop extends Template {
  ...
  public static function Process() {
    ...
    // Ajout des labels
    o::add_label(array('Edit proposition',
  ...
  public static function ShowProps() {
    ...
    for ($i = 1; $i <= o::get_env("nb_prop"); $i ++) {
      if (count($proposals) > 0 && $i < o::get_env("nb_prop") && ! isset($proposals['edit_prop' . $i])) {
        continue;
      }
      $params = array("id" => "edit_prop$i","type" => "text",
              "name" => "edit_prop$i","class" => "edit_prop",
      ...
      $html .= \Program\Lib\HTML\html::div(array(
              ...
              "style" => "width: 35%;","for" => "edit_prop$i"), Localization::g('Edit proposition')) . " " . $input->show(isset($proposals['edit_prop' . $i]) ? $proposals['edit_prop' . $i] : "") . " " . \Program\Lib\HTML\html::a(array(
              "class" => "pure-button pure-button-delete-date",
              "style" => "padding-top: 3px;",
              "onclick" => "deletePropDiv('edit_prop$i');"), "") . \Program\Lib\HTML\html::tag('br'));
    }
    return $html;
  }
}