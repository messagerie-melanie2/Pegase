...
$labels['Add'] = 'Ajouter une proposition +';
...
$labels['motif name'] = "Intitulé du motif";
...
$labels['Are you sure you want to delete the poll ?'] = 'Etes-vous sûr de vouloir supprimer ce sondage ?';
$labels['Are you sure you want to erase the poll ?'] = 'Etes-vous sûr de vouloir supprimer définitivement ce sondage (Cette action est définitive) ?';
$labels['Are you sure you want to restore the poll ?'] = 'Etes-vous sûr de vouloir restaurer ce sondage ?';
$labels['Are you sure you want to delete your response ?'] = 'Etes-vous sûr de vouloir supprimer votre reponse au sondage ?';
