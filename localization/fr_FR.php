...
$labels['Check to display proposals in my Agenda'] = 'Cochez cette case pour afficher les propositions dans votre Agenda lorsqu\'un utilisateur valide une proposition';
